...
namespace StudentRecordKeepingSystem
{
    public class Menu
    {
        static string connectionString = "server=localhost;user=root;database=student_record_keeping_system;port=3306;password=MARVELLOUS";
        static MySqlConnection conn = new MySqlConnection(connectionString);

        static StudentRepository studentRepo = new StudentRepository(conn);
        ...
        public void AddStudentDetails()
        {
            ...
            Console.Write("Enter your Class (Jss1 - Jss3): ");
            string studentClass = Console.ReadLine();

            studentRepo.AddStudent(firstName, lastName, email, phoneNumber, age, studentClass);
        }
        ...
        public void ShowStudentMenu()
        {
            ...
            switch (option)
            {
                ...
                case "2":
                    Console.Write("Enter email of Student you want to Find: ");
                    string email = Console.ReadLine();
